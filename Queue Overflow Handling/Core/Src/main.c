...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Main program body (FreeRTOS version with queue overflow)
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
    ...
    /* Create a queue to hold 5 pointers to SensorData_t */
    ...
    xTaskCreate(Task_ReceiveStruct, "ReceiverTask", 128, NULL, 2, &receiverTaskHandle);
...
void Task_SendStruct(void *pvParameters)
{
    ...
    for(;;)
    {
        ...
        // Send pointer to queue with overflow handling
